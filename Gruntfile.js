module.exports = function (grunt) {
    ...
    concat: {
      ...
      dist: {
        src: [
          ...
          './build/vendor/bootstrap/dist/js/bootstrap.min.js',
          './build/vendor/react/react.min.js',
          './build/vendor/react/react-dom.min.js',
          './build/bundle.js'
        ],
        dest: './build/app.js',
      },
  ...
  grunt.registerTask('default', ['clean', 'copy', 'sass', 'webpack', 'concat', 'watch']);
